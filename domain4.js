const DOMAIN4_QUESTIONS = [
  ...
  },
  {
    domain: 4,
    task: "4.2",
    q: "A company wants to estimate the costs of migrating an on-premises workload to AWS. Which option would best help the team?",
  ...
  },
  {
    domain: 4,
    task: "4.2",
    q: "A company wants to restrict member accounts in AWS Organizations from launching expensive instance types. Which choice best enforces this requirement?",
  ...
  },
  {
    domain: 4,
    task: "4.3",
    q: "A company wants a personalized AWS view that shows service events and scheduled changes affecting its own resources. Which option best supports that visibility need?",
    opts: [
  ...
  },
  {
    domain: 4,
    task: "4.3",
    q: "A company is planning a major product launch and wants AWS-led event preparation and guidance for the rollout. Which option best supports that launch-readiness goal?",
  ...
  { domain: 4, task: "4.3", q: "A small business needs the lowest-cost paid support option that still includes technical support cases. Which support choice best matches these needs?", opts: ["Basic Support", "Business Support+", "Enterprise Support", "AWS re:Post"], ans: 1, explain: "Business Support+ is the lowest-cost paid option that includes technical support cases." },

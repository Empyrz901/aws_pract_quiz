const DOMAIN4_QUESTIONS = [
  ...
  { domain: 4, task: "4.3", q: "Which AWS resource provides no-cost documentation and white papers?", opts: ["AWS Documentation", "AWS Support Center", "AWS re:Post", "AWS Trusted Advisor"], ans: 0, explain: "AWS documentation and whitepapers are available to all customers at no cost." },
  ...
  { domain: 4, task: "4.3", q: "Which AWS offering helps new customers experiment with select services within limited free usage tiers?", opts: ["AWS Marketplace", "AWS Free Tier", "AWS Training and Certification", "AWS Professional Services"], ans: 1, explain: "AWS Free Tier lets customers experiment with selected AWS services within limited usage levels at no cost." },
  ...
  { domain: 4, task: "4.3", q: "Which AWS support feature is a designated expert who provides proactive architectural guidance?", opts: ["AWS Support Center", "Technical Account Manager (TAM)", "AWS re:Post", "AWS Trusted Advisor"], ans: 1, explain: "A TAM is a designated AWS expert who provides proactive architectural guidance." },
  ...
  { domain: 4, task: "4.3", q: "Which AWS resource provides a curated collection of troubleshooting articles and common answers for AWS users?", opts: ["AWS Documentation", "AWS Knowledge Center", "AWS Support Center", "AWS re:Post"], ans: 1, explain: "AWS Knowledge Center provides a curated collection of troubleshooting articles and common answers for AWS users." },

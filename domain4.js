const DOMAIN4_QUESTIONS = [
  ...
  { domain: 4, task: "4.1", q: "A startup runs unpredictable workloads — some weeks they use 10 EC2 instances, other weeks only 2. They cannot commit to steady usage. Which pricing model suits them best?", opts: ["Reserved Instances for the maximum expected capacity", "On-Demand pricing — pay for exactly what they use with no commitment", "Spot Instances for all workloads to save the most", "Dedicated Hosts for full hardware isolation"], ans: 1, explain: "On-Demand charges only for actual usage with no commitments, ideal for unpredictable workloads. Reserved Instances require a commitment for steady use. Spot Instances can be interrupted. Dedicated Hosts are for compliance or licensing, not cost optimization for variable workloads." },
  { domain: 4, task: "4.1", q: "A company runs a production database 24/7 and knows their usage will be consistent for the next three years. Which pricing option provides the greatest savings?", opts: ["On-Demand Instances for flexibility", "Spot Instances for the deepest discounts", "Reserved Instances with a 3-year All Upfront payment", "Savings Plans with no upfront payment"], ans: 2, explain: "3-year All Upfront Reserved Instances provide the deepest discount (up to 72%) for steady-state workloads. On-Demand has no discount. Spot Instances are interruptible — unsuitable for databases. Savings Plans with no upfront still save money but less than All Upfront RIs." },
  { domain: 4, task: "4.1", q: "A data analytics team runs large batch processing jobs overnight and can restart if interrupted. Which pricing model gives them the lowest cost?", opts: ["On-Demand Instances at standard rates", "Spot Instances with up to 90% discount on spare EC2 capacity", "Reserved Instances with a 1-year commitment", "Dedicated Instances for performance isolation"], ans: 1, explain: "Spot Instances offer up to 90% discount and are ideal for fault-tolerant, interruptible workloads like batch processing. On-Demand is full price. Reserved Instances require commitments for steady use. Dedicated Instances cost more for hardware isolation, not cost savings." },
  { domain: 4, task: "4.1", q: "A company wants to save money on compute costs across EC2, Lambda, and Fargate with a single commitment. Which pricing model covers all three?", opts: ["EC2 Reserved Instances — they apply to all compute services", "Compute Savings Plans — they offer flexible discounts across EC2, Lambda, and Fargate", "Spot pricing — available for all compute services", "Free Tier — covers basic usage of all compute services"], ans: 1, explain: "Compute Savings Plans provide discounts across EC2, Lambda, and Fargate with usage commitments. Reserved Instances only apply to EC2. Spot pricing isn't available for Lambda or Fargate. Free Tier has very limited capacity, not a meaningful savings strategy." },
  { domain: 4, task: "4.2", q: "A company's AWS bill increased unexpectedly last month. The finance team needs to identify which service and account caused the spike. Which tool should they use?", opts: ["AWS Budgets to set spending alerts for next month", "AWS Cost Explorer to analyze spending by service, account, and time period", "AWS Pricing Calculator to estimate future costs", "AWS Trusted Advisor for cost optimization recommendations"], ans: 1, explain: "Cost Explorer provides detailed visualizations of spending patterns filtered by service, account, tag, and date range. Budgets alert on future spending but don't analyze past spikes. Pricing Calculator estimates new workloads. Trusted Advisor gives optimization tips but not detailed spending analysis." },
  ...
  { domain: 4, task: "4.2", q: "A company with five business units wants each unit to track and manage their own AWS costs independently. Which AWS feature supports this organizational structure?", opts: ["AWS Organizations with separate accounts per business unit and consolidated billing", "AWS Billing Conductor", "Cost allocation tags", "AWS Budgets"], ans: 0, explain: "AWS Organizations lets each business unit have its own account for independent cost tracking while benefiting from consolidated billing and volume discounts. Billing Conductor shapes cost presentation, tags help with attribution, and Budgets help with thresholds, but none of them replace separate accounts for isolation." },
  ...
  { domain: 4, task: "4.1", q: "A company wants to experiment with several AWS services to determine which ones meet their needs, without incurring costs for the first 12 months. Which program helps?", opts: ["AWS Savings Plans", "AWS Free Tier", "AWS Credits", "AWS Enterprise Discount Program"], ans: 1, explain: "AWS Free Tier includes 12-month free offers for services like EC2, S3, and RDS at limited usage levels. Savings Plans require commitments. Credits are not automatic for all accounts. Enterprise Discount Program is negotiated for large customers, not for experimentation." },
  { domain: 4, task: "4.2", q: "A company's cloud team wants a programmatic way to analyze their AWS cost and usage data in detail, beyond what the AWS console provides. Which feature enables this?", opts: ["AWS Cost Explorer API for programmatic cost queries", "AWS Cost and Usage Report (CUR) exported to S3 for detailed line-item analysis", "AWS Budgets API for setting budget alerts programmatically", "AWS Billing Dashboard for a summary of current charges"], ans: 1, explain: "The Cost and Usage Report provides the most detailed billing data (line-item level) delivered to S3 for custom analysis with Athena, Redshift, or QuickSight. Cost Explorer API provides aggregate queries but not line-item detail. Budgets API manages alerts. Billing Dashboard is a console summary." },
  { domain: 4, task: "4.3", q: "A company is evaluating their AWS architecture and wants a structured review based on the six pillars of the Well-Architected Framework. Which AWS tool facilitates this?", opts: ["AWS Trusted Advisor for automated best-practice checks", "AWS Well-Architected Tool for structured workload reviews against the six pillars", "AWS Config for resource compliance auditing", "AWS CloudFormation for infrastructure validation"], ans: 1, explain: "The Well-Architected Tool provides a structured questionnaire based on the six pillars (Operational Excellence, Security, Reliability, Performance Efficiency, Cost Optimization, Sustainability) to review workloads. Trusted Advisor is automated checks, not a structured review. Config audits compliance rules. CloudFormation validates templates, not architecture." },
  { domain: 4, task: "4.1", q: "A company runs workloads across multiple EC2 instance types and sizes and wants flexible pricing discounts without being locked to a specific instance family. Which option provides this?", opts: ["Standard Reserved Instances", "Convertible Reserved Instances", "Compute Savings Plans", "Spot Instances"], ans: 2, explain: "Compute Savings Plans offer the most flexibility, applying discounts to any EC2 instance regardless of family, size, Region, or OS. Standard RIs are locked to one instance type. Convertible RIs allow changes but with less flexibility than Savings Plans. Spot Instances aren't commitment-based pricing — they're auction-based and interruptible." },
  ,
  ...
  { domain: 4, task: "4.2", q: "A company wants to understand which departments are driving cloud spend and also receive alerts before any department exceeds its monthly target. Which AWS features should they implement? (Select TWO)", opts: ["Cost allocation tags", "AWS Budgets", "AWS Cost and Usage Report", "AWS Billing Conductor", "AWS Cost Explorer"], ans: [0, 1], multi: true, explain: "Cost allocation tags let the team attribute spend by department, and AWS Budgets provides threshold alerts for actual or forecasted spending. The other services do not manage billing attribution or budget alerts." },
  { domain: 4, task: "4.2", q: "A company wants detailed billing data delivered for custom analytics in Amazon Athena, while also giving executives a simpler interactive console view of cost trends and forecasts. Which AWS tools support these two needs? (Select TWO)", opts: ["AWS Cost and Usage Report (CUR)", "AWS Cost Explorer", "AWS Cost Anomaly Detection", "AWS Billing Conductor", "AWS Budgets"], ans: [0, 1], multi: true, explain: "CUR provides the granular line-item data needed for custom analytics, and Cost Explorer provides an easier interactive interface for trend and forecast analysis. The other options do not provide billing data analysis for these use cases." },

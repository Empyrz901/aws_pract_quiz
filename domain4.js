const DOMAIN4_QUESTIONS = [
  ...
  { domain: 4, task: "4.1", q: "A company wants to experiment with several AWS services to determine which ones meet their needs, without incurring costs for the first 12 months. Which program helps?", opts: ["AWS Savings Plans — commit to low usage for reduced rates", "AWS Free Tier — offers free usage of many services for 12 months after account creation", "AWS Credits — applied automatically to all new accounts", "AWS Enterprise Discount Program — negotiated pricing for experimentation"], ans: 1, explain: "AWS Free Tier includes 12-month free offers for services like EC2, S3, and RDS at limited usage levels. Savings Plans require commitments. Credits are not automatic for all accounts. Enterprise Discount Program is negotiated for large customers, not for experimentation." },

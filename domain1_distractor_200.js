function generateDomain1DistractorQuestions() {
  ...
  const templates = [
    { task: "1.1", q: (c, k) => `${c} is launching a new service with unpredictable traffic and wants to avoid overprovisioning. Leadership requires ${k}. Which AWS benefit should they prioritize?`, opts: ["Elasticity", "Scalability", "Reserved capacity planning", "Capacity right-sizing reviews"], ans: "Elasticity", next: "Scalability", win: "Elasticity matches variable demand and avoids paying for idle resources.", lose: "Scalability supports growth, but elasticity is the more direct fit for quickly expanding and shrinking with demand." },
    { task: "1.1", q: (c, k) => `${c} needs global users to experience consistently low latency for static web assets. The product owner demands ${k}. Which AWS concept best supports this goal?`, opts: ["Edge locations via content delivery", "Multi-AZ deployment in one Region", "Regional high availability", "Centralized VPC design"], ans: "Edge locations via content delivery", next: "Multi-AZ deployment in one Region", win: "Serving content near users with edge locations reduces latency globally.", lose: "Multi-AZ improves availability inside a Region, but it does not provide worldwide edge proximity." },
    { task: "1.2", q: (c, k) => `${c} wants to improve architecture quality and run periodic reviews with minimal custom framework design. The CTO requests ${k}. Which AWS resource should they use?`, opts: ["AWS Well-Architected Framework", "AWS Artifact", "AWS Trusted Advisor", "AWS Resilience Hub"], ans: "AWS Well-Architected Framework", next: "AWS Trusted Advisor", win: "Well-Architected provides structured best-practice reviews across core pillars.", lose: "Trusted Advisor offers useful checks, but it is not the primary framework for structured architecture reviews." },
    ...
    { task: "1.4", q: (c, k) => `${c} is comparing infrastructure options and needs to evaluate all direct and indirect lifecycle expenses. The CFO insists on ${k}. Which analysis should the team perform?`, opts: ["Total Cost of Ownership (TCO) analysis", "Return on Investment (ROI) analysis", "Unit cost benchmarking", "Monthly spend trend analysis"], ans: "Total Cost of Ownership (TCO) analysis", next: "Return on Investment (ROI) analysis", win: "TCO captures broad lifecycle costs including operations, facilities, and labor.", lose: "ROI helps compare business value to investment, but it does not fully replace a lifecycle cost analysis." },
    ...
    { task: "1.4", q: (c, k) => `${c} wants to compare on-prem and cloud economics including staff effort, facilities, and maintenance contracts. Finance requires ${k}. Which metric is most appropriate?`, opts: ["TCO", "ROI", "Cost allocation tags", "Unit price comparison"], ans: "TCO", next: "ROI", win: "TCO includes comprehensive cost categories beyond isolated service unit prices.", lose: "ROI can be useful for business justification, but it is not the direct measure of full lifecycle cost." },

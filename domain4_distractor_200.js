function generateDomain4DistractorQuestions() {
  ...
  const templates = [
    ...
    { task: "4.2", q: (c, k) => `${c} wants centralized billing and consolidated payment across multiple AWS accounts under one organization. Finance requires ${k}. Which feature is most appropriate?`, opts: ["AWS Organizations consolidated billing", "AWS Billing Conductor", "Cost allocation tags", "AWS Budgets"], ans: "AWS Organizations consolidated billing", next: "AWS Billing Conductor", win: "Consolidated billing centralizes invoicing and can improve discount utilization.", lose: "Billing Conductor changes cost presentation, but it does not replace consolidated payment." },
